...
- **[AnalogJS](https://analogjs.org/)** (Vite integration layer for Angular in this project)
...
- **[Commitizen](https://commitizen-tools.github.io/commitizen/)** (Conventional commits assistant)
- **[cz-conventional-changelog](https://github.com/commitizen/cz-conventional-changelog)** (Commitizen adapter)
