describe('Debit Account Insert Page', () => {
  ...
  it('should create a new Debit Account successfully', () => {
  ...
  describe('Validation Tests', () => {
    it('AC-01: should fail when trying to create debit account with only whitespaces', () => {
      cy.fixture('accounts').then((accountsData) => {
        ...
        cy.url({ timeout: 5000 }).should('include', '/debitAccounts/new');
      });
    });

    it('AC-02: should create debit account successfully using 3 characters (lower limit)', () => {
      cy.fixture('accounts').then((accountsData) => {
    ...
    it('AC-03: should create debit account successfully using 255 characters (upper limit)', () => {
      cy.fixture('accounts').then((accountsData) => {
    ...
    it.skip('AC-04: should fail when trying to create debit account with 256 characters (exceeds upper limit)', () => {
      cy.fixture('accounts').then((accountsData) => {
    ...
    it('AC-05: should fail when trying to create debit account with empty category', () => {
      cy.fixture('accounts').then((accountsData) => {
    ...
    it('AC-06: should create debit account successfully with valid category', () => {
