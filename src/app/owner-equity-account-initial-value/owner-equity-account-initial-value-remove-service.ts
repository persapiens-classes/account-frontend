...
export const OWNER_EQUITY_ACCOUNT_INITIAL_VALUE_REMOVE_SERVICE = new InjectionToken<OwnerEquityAccountInitialValueRemoveService>('OwnerEquityAccountInitialValueRemoveService')