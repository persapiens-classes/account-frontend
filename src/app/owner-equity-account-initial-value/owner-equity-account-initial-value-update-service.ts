...
export class OwnerEquityAccountInitialValueUpdateService extends BeanUpdateService<OwnerEquityAccountInitialValue, number> {
...
export const OWNER_EQUITY_ACCOUNT_INITIAL_VALUE_UPDATE_SERVICE = new InjectionToken<OwnerEquityAccountInitialValueUpdateService>('OwnerEquityAccountInitialValueUpdateService')