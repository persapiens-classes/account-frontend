...
import { OwnerEquityAccountInitialValueFormGroupService } from './owner-equity-account-initial-value-form-group.service';
...
export class OwnerEquityAccountInitialValueInsertComponent extends BeanInsertComponent<OwnerEquityAccountInitialValue, OwnerEquityAccountInitialValueInsert, number> {
  ...
  constructor(
    http: HttpClient,
    ownerEquityAccountInitialValueFormGroupService: OwnerEquityAccountInitialValueFormGroupService,
