...
import { CREDIT_CATEGORY_REMOVE_SERVICE, DEBIT_CATEGORY_REMOVE_SERVICE, EQUITY_CATEGORY_REMOVE_SERVICE } from "../category/category-remove-service";
import { OWNER_REMOVE_SERVICE } from "../owner/owner-remove-service";
import { CREDIT_ACCOUNT_REMOVE_SERVICE, DEBIT_ACCOUNT_REMOVE_SERVICE, EQUITY_ACCOUNT_REMOVE_SERVICE } from "../account/account-remove-service";
import { CREDIT_ENTRY_REMOVE_SERVICE, DEBIT_ENTRY_REMOVE_SERVICE, TRANSFER_ENTRY_REMOVE_SERVICE } from "../entry/entry-remove-service";
...
export class BeanRemoveServiceFactory<T extends Bean> {
  ...
  constructor() {
    ...
    this.mapApiRemoveService.set('OwnerEquityAccountInitialValueRemoveService', OWNER_EQUITY_ACCOUNT_INITIAL_VALUE_REMOVE_SERVICE)
  }
