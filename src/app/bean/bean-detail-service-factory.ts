...
import { CREDIT_CATEGORY_DETAIL_SERVICE, DEBIT_CATEGORY_DETAIL_SERVICE, EQUITY_CATEGORY_DETAIL_SERVICE } from "../category/category-detail-service";
import { CREDIT_ACCOUNT_DETAIL_SERVICE, DEBIT_ACCOUNT_DETAIL_SERVICE, EQUITY_ACCOUNT_DETAIL_SERVICE } from "../account/account-detail-service";
import { CREDIT_ENTRY_DETAIL_SERVICE, DEBIT_ENTRY_DETAIL_SERVICE, TRANSFER_ENTRY_DETAIL_SERVICE } from "../entry/entry-detail-service";
