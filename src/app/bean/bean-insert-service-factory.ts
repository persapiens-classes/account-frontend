...
import { CREDIT_CATEGORY_INSERT_SERVICE, DEBIT_CATEGORY_INSERT_SERVICE, EQUITY_CATEGORY_INSERT_SERVICE } from "../category/category-insert-service";
import { OWNER_INSERT_SERVICE } from "../owner/owner-insert-service";
import { CREDIT_ACCOUNT_INSERT_SERVICE, DEBIT_ACCOUNT_INSERT_SERVICE, EQUITY_ACCOUNT_INSERT_SERVICE } from "../account/account-insert-service";
import { CREDIT_ENTRY_INSERT_SERVICE, DEBIT_ENTRY_INSERT_SERVICE, TRANSFER_ENTRY_INSERT_SERVICE } from "../entry/entry-insert-service";
...
export class BeanInsertServiceFactory<T extends Bean, I> {
  ...
  constructor() {
    ...
    this.mapApiInsertService.set('OwnerEquityAccountInitialValueInsertService', OWNER_EQUITY_ACCOUNT_INITIAL_VALUE_INSERT_SERVICE)
  }
