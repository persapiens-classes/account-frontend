...
import { SelectFieldSComponent as ISelectFieldSComponent } from './fields-component';
...
export class SelectFieldSComponent<T = unknown> implements ISelectFieldSComponent<T> {
  id = input<string>('id');
