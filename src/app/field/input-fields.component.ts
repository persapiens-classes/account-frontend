...
import { StringFieldSComponent } from './fields-component';
...
@Component({
  ...
  template: `
    <p-float-label variant="in" class="mb-2.5">
      <input [id]="id()" [name]="name()" pInputText [pAutoFocus]="autoFocus()" [field]="field()" />
...
export class InputFieldSComponent implements StringFieldSComponent {
  id = input<string>('id');
