...
import { CategoryInsertService, CREDIT_CATEGORY_INSERT_SERVICE, DEBIT_CATEGORY_INSERT_SERVICE, EQUITY_CATEGORY_INSERT_SERVICE } from './category/category-insert-service';
import { AccountUpdateService, CREDIT_ACCOUNT_UPDATE_SERVICE, DEBIT_ACCOUNT_UPDATE_SERVICE, EQUITY_ACCOUNT_UPDATE_SERVICE } from './account/account-update-service';
import { CREDIT_ENTRY_UPDATE_SERVICE, DEBIT_ENTRY_UPDATE_SERVICE, EntryUpdateService, TRANSFER_ENTRY_UPDATE_SERVICE } from './entry/entry-update-service';
import { OWNER_INSERT_SERVICE, OwnerInsertService } from './owner/owner-insert-service';
import { OWNER_EQUITY_ACCOUNT_INITIAL_VALUE_INSERT_SERVICE, OwnerEquityAccountInitialValueInsertService } from './owner-equity-account-initial-value/owner-equity-account-initial-value-insert-service';
import { MessageService } from 'primeng/api';
import { BALANCE_LIST_SERVICE, BalanceListService } from './owner-equity-account-initial-value/balance-list-service';
import { CategoryDetailService, CREDIT_CATEGORY_DETAIL_SERVICE, DEBIT_CATEGORY_DETAIL_SERVICE, EQUITY_CATEGORY_DETAIL_SERVICE } from './category/category-detail-service';
import { CategoryListService, CREDIT_CATEGORY_LIST_SERVICE, DEBIT_CATEGORY_LIST_SERVICE, EQUITY_CATEGORY_LIST_SERVICE } from './category/category-list-service';
import { CategoryRemoveService, CREDIT_CATEGORY_REMOVE_SERVICE, DEBIT_CATEGORY_REMOVE_SERVICE, EQUITY_CATEGORY_REMOVE_SERVICE } from './category/category-remove-service';
import { CategoryUpdateService, CREDIT_CATEGORY_UPDATE_SERVICE, DEBIT_CATEGORY_UPDATE_SERVICE, EQUITY_CATEGORY_UPDATE_SERVICE } from './category/category-update-service';
import { AccountInsertService, CREDIT_ACCOUNT_INSERT_SERVICE, DEBIT_ACCOUNT_INSERT_SERVICE, EQUITY_ACCOUNT_INSERT_SERVICE } from './account/account-insert-service';
import { CREDIT_ENTRY_INSERT_SERVICE, DEBIT_ENTRY_INSERT_SERVICE, EntryInsertService, TRANSFER_ENTRY_INSERT_SERVICE } from './entry/entry-insert-service';
import { AccountDetailService, CREDIT_ACCOUNT_DETAIL_SERVICE, DEBIT_ACCOUNT_DETAIL_SERVICE, EQUITY_ACCOUNT_DETAIL_SERVICE } from './account/account-detail-service';
import { CREDIT_ENTRY_DETAIL_SERVICE, DEBIT_ENTRY_DETAIL_SERVICE, EntryDetailService, TRANSFER_ENTRY_DETAIL_SERVICE } from './entry/entry-detail-service';
import { OWNER_DETAIL_SERVICE, OwnerDetailService } from './owner/owner-detail-service';
import { AccountListService, CREDIT_ACCOUNT_LIST_SERVICE, DEBIT_ACCOUNT_LIST_SERVICE, EQUITY_ACCOUNT_LIST_SERVICE } from './account/account-list-service';
import { CREDIT_ENTRY_LIST_SERVICE, DEBIT_ENTRY_LIST_SERVICE, EntryListService, TRANSFER_ENTRY_LIST_SERVICE } from './entry/entry-list-service';
import { OWNER_LIST_SERVICE, OwnerListService } from './owner/owner-list-service';
import { AccountRemoveService, CREDIT_ACCOUNT_REMOVE_SERVICE, DEBIT_ACCOUNT_REMOVE_SERVICE, EQUITY_ACCOUNT_REMOVE_SERVICE } from './account/account-remove-service';
import { CREDIT_ENTRY_REMOVE_SERVICE, DEBIT_ENTRY_REMOVE_SERVICE, EntryRemoveService, TRANSFER_ENTRY_REMOVE_SERVICE } from './entry/entry-remove-service';
...
import { BALANCE_DETAIL_SERVICE, BalanceDetailService } from './owner-equity-account-initial-value/balance-detail-service';
import { OWNER_EQUITY_ACCOUNT_INITIAL_VALUE_UPDATE_SERVICE, OwnerEquityAccountInitialValueUpdateService } from './owner-equity-account-initial-value/owner-equity-account-initial-value-update-service';
import { OWNER_EQUITY_ACCOUNT_INITIAL_VALUE_REMOVE_SERVICE, OwnerEquityAccountInitialValueRemoveService } from './owner-equity-account-initial-value/owner-equity-account-initial-value-remove-service';
